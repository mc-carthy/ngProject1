System.register(["angular2/core", "angular2/router", "./home.component", "./navbar.component", "./users/users.component", "./users/user-form.component", "./posts/posts.component", "./not-found.component"], function (exports_1, context_1) {
    "use strict";
    ...
    var core_1, router_1, home_component_1, navbar_component_1, users_component_1, user_form_component_1, posts_component_1, not_found_component_1, AppComponent;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
